  ...
  func checkEdit(){
    ...
    func showInputAlert() {
        ...
        alert.addTextField { (textField:UITextField!) -> Void in
          textField.text = "お気に入り_" + String(self.user.setNum)
        }
    ...
    func setupVolumeSlider() {
      ...
      /* 1373行目の
       ...
       これでもダメそうなら3とかにしたらいけると思う */
        ...
        volumeView.frame.size.width = self.view.bounds.width / 3
